...
title([ 'Correlation over trials from seed ' sensor2 ', ' num2str(centerfreq2) ' Hz and ' num2str(timewin2(1)) '-' num2str(timewin2(2)) ' ms' ], 'FontSize', 14)
set(gca, 'FontSize', 14)

% Change colorbar limits and set color map
h = colorbar;
colormap jet;
caxis([-0.4 0.4]);
colorbar('Limits', [-0.4 0.4], 'Ticks', [-0.4 -0.2 0 0.2 0.4]);
cmap = colormap;
cmap(end,:) = [1 0 0]; % Change upper limit color to red
colormap(cmap);
